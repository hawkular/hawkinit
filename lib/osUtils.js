...
const prepareVolumeDirs = () => {
  ...
  const changeSELinuxContext = `chcon -Rt svirt_sandbox_file_t ${volumeHome}`;
  ...
  try {
    ...
    console.log(chalk.red(`Unable to change the SE Linux context of ${volumeHome} to svirt_sandbox_file_t. ` +
