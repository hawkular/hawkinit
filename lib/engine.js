...
const runOpenshift = (answers, timeout) => {
  ...
  const startServices = `oc cluster down &> /dev/null ; ${parameters} ./lib/configs/openshift/startEphemeral.sh`;
  ...
  const addHafkfly = `oc process -f ./lib/configs/openshift/hawkfly.yaml ${params} | oc create -f -`;
