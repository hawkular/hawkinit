...
const HAWKULAR_VERSIONS = ['latest', 'devel', '0.34.0.Final', '0.33.0.Final', '0.32.0.Final', '0.31.0.Final',
...
const show = (save, timeout) => {
  ...
  const questions = [
    ...
    },
    {
      ...
      filter: Number,
      when: answers => answers.wfType === 'Standalone' || answers.orchestrationFramework === 'openshift'
    },
    {
      type: 'list',
