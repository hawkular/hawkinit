...
const show = (save, timeout, full) => {
  ...
  const questions = [
    ...
    },
    {
      type: 'confirm',
      name: 'ssl',
      message: 'Do you want to use hawkular services over SSL with auto-generated self-signed certificate? (available since ' +
        '0.35.0)',
      default: false,
      when: () => full
    },
    ...
    },
    {
      ...
      default: 'Subsystem',
      choices: ['Subsystem', {
        name: 'Java agent (not yet implemented)',
        value: 'javaAgent'
      }, 'None'],
      when: () => full
    },
    ...
    },
    {
      ...
      when: answers => answers.wfType === 'Standalone' && (!answers.hawkflyWfEap || answers.hawkflyWfEap === 'WildFly')
    },
    {
      type: 'list',
