...
const ServiceArrayProperties = ['ports', 'links'];
...
Builder.prototype.service = (name) => {
...
Builder.prototype.hasService = name => typeof this._dockerCompose.services[name] === 'undefined';
